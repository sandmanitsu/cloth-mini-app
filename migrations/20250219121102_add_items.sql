...
-- Mock
INSERT INTO
    public.items (name, brand, description, sex, category_id, size_amount, price, discount, outer_link)
VALUES
    ('Кардиган DEVIL LOGO', 'Daze', 'Кардиган в исполнении российского streetwear бренда Daze', '1', '6', '{"s":2,"m":3,"l":0,"xl":1}', '28000', '0', 'https://nuw.store/catalog/svitery_i_kardigany/kardigan_devil_logo_1-color-raznocvetnyj/');

INSERT INTO
    public.items (name, brand, description, sex, category_id, size_amount, price, discount, outer_link)
VALUES
    ('Худи WWW.S DOUBLE SIDED', 'Gleb Kostin .Solutions', 'Худи в исполнении Gleb Kostin Solutions', '1', '7', '{"s":1,"m":10,"l":1,"xl":2}', '14780', '10', 'https://nuw.store/catalog/tolstovki/khudi_www_s_double_sided-color-chernyj/');

INSERT INTO
    public.items (name, brand, description, sex, category_id, size_amount, price, discount, outer_link)
VALUES
    ('Кроссовки MXR TECH', 'Mizuno', 'Модель MXR отражает наше стремление распространить опыт ретро-бега Mizuno 2000-х годов в качестве дополнения к всемирно известной модели Wave Rider 10.', '1', '12', '{"37":1,"40":2,"41":3,"42":0,"46":1}', '15990', '0', 'https://nuw.store/catalog/krossovki/krossovki_mxr_tech-color-raznocvetnyj/');
