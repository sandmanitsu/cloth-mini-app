...
CREATE TABLE IF NOT EXISTS public.items (
    ...
    FOREIGN KEY (brand_id) REFERENCES public.brand (id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (category_id) REFERENCES public.category (id) ON UPDATE CASCADE ON DELETE CASCADE
);
